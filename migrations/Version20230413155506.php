 ...
 */
final class Version20230413155506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, date_reservation DATE NOT NULL, hour_reservation VARCHAR(100) NOT NULL, number_people INT NOT NULL, allergy LONGTEXT DEFAULT NULL, civility VARCHAR(20) NOT NULL, firstname VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, phone VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_E00CEDDE67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
