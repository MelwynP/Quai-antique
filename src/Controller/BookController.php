...
class BookController extends AbstractController
{
  ...
  public static function getTotalBooking($serviceType, $dateReservation, BookingRepository $bookingRepository)
  // number of reservations for a given date and service type
  {
    $ret = 0;
